# # ==========================================
# # Quantum Hackathon – All 3 Simulations
# # Qiskit 2.2.1 Compatible
# # ==========================================
...
# job1 = sim.run(qc1, shots=1024)
# result1 = job1.result()
# counts1 = result1.get_counts()

# print(f"Alice's operation: {alice_op}")
# qc1.draw('mpl')
# plt.show()

# plot_histogram(counts1, title="Quantum Communication Results")
# plt.show()

# # Bloch sphere (before measurement)
# qc1_no_meas = QuantumCircuit(2)
# qc1_no_meas.h(0)
# qc1_no_meas.cx(0,1)
# state1 = Statevector.from_instruction(qc1_no_meas)
...
# ==========================================
# Quantum Hackathon – All 3 Simulations
# Qiskit 2.2.1 Compatible with Modern UI
# ==========================================
...
# with st.sidebar:
#     st.image("https://upload.wikimedia.org/wikipedia/commons/9/9d/Qiskit-Logo.svg", width=150)
...
#     st.markdown("""
#     <div class="info-box">
#     <h4>🧠 How Quantum Communication Works:</h4>
#     <ol>
#         <li><b>Create Bell State</b>: Entangle two qubits using H and CNOT gates</li>
#         <li><b>Alice's Operation</b>: Apply selected quantum gate to first qubit</li>
#         <li><b>Measurement</b>: Measure both qubits to observe quantum correlations</li>
#     </ol>
#     </div>
#     """, unsafe_allow_html=True)
...
#             fig_bloch, ax_bloch = plt.subplots(figsize=(6, 6))
#             plot_bloch_multivector(results['statevector'], ax=ax_bloch)
#             ax_bloch.set_title("Quantum State Vector\n(Before Measurement)", fontweight='bold')
#             st.pyplot(fig_bloch)
...
#                     prob = count/total
#                     st.write(f"• **State |{state}⟩**: {prob:.2%} probability")

# # Footer
# st.markdown("---")
# st.markdown(
#     "<div style='text-align: center; color: #666;'>"
#     "Built with Qiskit ⚛️ | Quantum Communication Simulator | Streamlit UI"
#     "</div>",
#     unsafe_allow_html=True
# )
